...
st.set_page_config(
    page_title="11777 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - 11777</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'D:\Matakuliah Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\Unsupervised Learning (Praktek)\Tugas4_A_11777'
    model_path = {
